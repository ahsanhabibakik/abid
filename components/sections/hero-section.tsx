...
export function HeroSection() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 to-brand-100 dark:from-neutral-900 dark:to-neutral-800">
          ...
          >
            <div className="relative w-full max-w-md mx-auto">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-brand-mint/60 to-brand-meadow/60 flex items-center justify-center">
                <div className="w-4/5 h-4/5 rounded-xl bg-card flex items-center justify-center border-2 border-brand-300">
