...
export function PortfolioSection() {
  ...
  return (
    <section id="portfolio" className="py-24 bg-gradient-to-b from-white to-brand-50 dark:from-neutral-900 dark:to-neutral-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredItems.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-card rounded-xl overflow-hidden shadow-sm border border-border hover:shadow-lg hover:border-brand-leaf transition-all"
            >
